...
class MBAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for i in range(self.ensemble_size):
            ...
            observations = ob_no[i*num_data_per_ens:num_data_per_ens*(i+1)]
            actions =  ac_na[i*num_data_per_ens:num_data_per_ens*(i+1)]
            next_observations = next_ob_no[i*num_data_per_ens:num_data_per_ens*(i+1)]
